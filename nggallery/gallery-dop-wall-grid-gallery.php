...
*/
    ...
    // Register JavaScript.
    wp_register_script('DOPNGWGG_MouseWheelJS', get_template_directory_uri().'/nggallery/libraries/js/jquery.mousewheel.js', array('jquery'));
    wp_register_script('DOPNGWGG_JScrollPaneJS', get_template_directory_uri().'/nggallery/libraries/js/jquery.jscrollpane.min.js', array('jquery'));
    wp_register_script('DOPNGWGG_NextGENWallGridGalleryJS', get_template_directory_uri().'/nggallery/assets/js/jquery.dop.NextGENWallGridGallery.js', array('jquery'));
    wp_register_script('DOPNGWGG_DOPNGWGGJS', get_template_directory_uri().'/nggallery/assets/js/dopngwgg.js', array('jquery'));
    ...
    wp_enqueue_script('DOPNGWGG_DOPNGWGGJS');
...
<!--    
    var DOPNextGENWallGridGallerySettings<?php echo $gallery->ID;?> = {
        "Width": 792, // Width (value in pixels). Default value: 900. Set the width of the gallery.
        ...
        "BgColor": "none", // Background Color (color hex code). Default value: f1f1f1. Set gallery background color.
        ...
        "ThumbnailsSpacing": 20, // Thumbnails Spacing (value in pixels). Default value: 15. Set the space between thumbnails.
        ...
        "ThumbnailsInfo": "none", // Info Thumbnails Display (none, tooltip, label). Default value: tooltip. Display a small info text on the thumbnails, a tooltip or a label on bottom.
        ...
        "ThumbnailHeight": 150, // Thumbnail Height (the size in pixels). Default value: 100. Set the height of a thumbnail.
        ...
        "ThumbnailHeightMobile": 75, // Mobile Thumbnail Height (the size in pixels). Default value: 50. Set the height of a thumbnail on mobile devices.
        "ThumbnailAlpha": 80, // Thumbnail Alpha (value from 0 to 100). Default value: 80. Set the transparancy of a thumbnail.
        ...
        "CaptionHeight": 175, // Caption Height (value in pixels). Default value: 75. Set caption height.
...
<div class="DOPNextGENWallGridGallery" id="DOPNextGENWallGridGallery<?php echo $gallery->ID; ?>"></div>
<?php
        echo $pagination;
    }
?>