        ...
        methods = {
                    init:function( ){// Init Plugin.
                        return this.each(function(){                            
                            ...
                            $(window).bind('scroll.DOPNextGENWallGridGallery', methods.initRP);
                        });
                    },
                    ...
                    rpLightboxMedia:function(){// Resize & Position Lightbox Media
                        ...
                        $('#DOP_NextGENWallGridGallery_LightboxWrapper_'+ID+' .DOP_NextGENWallGridGallery_Lightbox').css({'height': documentH,
                                                                                                            'width': documentW});
                                                                                                          
                        var currW = $('#DOP_NextGENWallGridGallery_LightboxWrapper_'+ID+' .DOP_NextGENWallGridGallery_Lightbox').children().width(),
                    ...
                    initCaption:function(){// Init Caption
                        $('.DOP_NextGENWallGridGallery_Caption').css({'margin-left': LightboxPaddingLeft,
                                                               'bottom': LightboxPaddingBottom});
                        $('.DOP_NextGENWallGridGallery_CaptionTitle', Container).css('color', '#'+CaptionTitleColor);
                        $('.DOP_NextGENWallGridGallery_CaptionText', Container).css('color', '#'+CaptionTextColor);
